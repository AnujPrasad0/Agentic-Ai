...
export default function App() {
  ...
  return (
    <div className="relative">
      ...
      <div className="z-1 absolute w-[50%] h-[50%] rounded-t-full bg-[radial-gradient(circle_at_bottom,_#44DD65_10%,_#e9e9e9_60%)] dark:bg-[radial-gradient(circle_at_bottom,_#41d58b_10%,_#070b0c_60%)] left-[50%] top-[50%] translate-[-50%]"></div>
